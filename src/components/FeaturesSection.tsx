...
export default function FeaturesSection() {
  ...
  return (
    <section className="relative bg-[#f3e6d3] px-5 md:px-10 lg:px-16 py-20 md:py-40 lg:py-48">
      <div className="grid lg:grid-cols-[400px_1fr] xl:grid-cols-[460px_1fr] gap-10 lg:gap-24 xl:gap-48">
        ...
        <div className="flex flex-col gap-8 md:gap-12">
          {FEATURES.map((feature, index) => (
            ...
            >
              ...
              <p className="text-black/60 font-medium text-sm md:text-base leading-relaxed text-center lg:text-left">
                {feature.description}
              </p>
            </div>
          ))}
