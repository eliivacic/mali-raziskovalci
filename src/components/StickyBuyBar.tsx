export default function StickyBuyBar() {
  return (
    <div className="fixed bottom-0 inset-x-0 z-40 bg-[#b08b65] px-4 md:px-8 py-3 flex items-center justify-center md:justify-between gap-4 shadow-[0_-4px_16px_rgba(0,0,0,0.15)]">
